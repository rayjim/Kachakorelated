...
import kachako.ml.crf_old.PseudoBuffer;
...
public class DataCruncher {
    ...
    static int readRowVarCol(int numLabels, PseudoBuffer tin, String tagDelimit, String delimit, String impDelimit, int[] t, String[][] cArray) throws IOException 
    {
	int ptr=0;
	int previousLabel = -1;
	while(true) {
	    ...
	    String l = firstSplit.nextToken();
	   // System.out.println(l);
	    int label=Integer.parseInt(l.trim()); 
    ...
    static int readRowFixedCol(int numLabels, PseudoBuffer tin, String tagDelimit, String delimit, String impDelimit, int[] t, String[][] cArray, int labels[], StringTokenizer rawTok) throws IOException {
	String line=tin.readLine();
	if (line == null)
	    return 0;
    ...
    static int[] readHeaderInfo(int numLabels, PseudoBuffer tin, String tagDelimit) throws IOException {
	//tin.mark(1000);
	String line = tin.readLine();
	if (line == null)
    ...
    public static TrainData readTagged(int numLabels,PseudoBuffer tin,String delimit,String tagDelimit,String impDelimit, LabelMap labelMap) {
	try {
		...
		StringTokenizer tLine=new StringTokenizer(line,tagDelimit);
	
		    rawLine=rawLine+" "+tLine.nextToken();
	...
	//	System.out.println(labelMap.map(1));
