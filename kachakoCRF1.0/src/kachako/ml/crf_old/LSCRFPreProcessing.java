...
public class LSCRFPreProcessing extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(LSCRFPreProcessing.class);
  ...
  public static void main(String[] args) throws Exception {
	int exitCode =0;
     ...
     exitCode = ToolRunner.run(new LSCRFPreProcessing(), args);
